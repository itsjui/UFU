...
SELECT nome_cliente FROM deposito 
except 
...
SELECT nome_cliente FROM cliente
WHERE nome_cliente LIKE '%Souza' OR nome_cliente LIKE '%Sousa';

--10-Total de depósitos para cada nome de cliente
SELECT nome_cliente, sum(saldo_deposito) FROM deposito 
GROUP BY nome_cliente;

--11-Nomes de clientes e depósitos que estão entre R$ 3.000,00 e R$ 4.000,00
SELECT nome_cliente, saldo_deposito FROM deposito 
